...
const PARAMETER_PROMPTS: Partial<Record<ParameterKey, string>> = {
...
const FOLLOW_UP_PROMPTS: Partial<Record<ParameterKey, string>> = {
...
export function getNextMockResponse(
  ...
  if (currentParameter) {
    return PARAMETER_PROMPTS[currentParameter] || '请继续回答下一个问题：';
  }
